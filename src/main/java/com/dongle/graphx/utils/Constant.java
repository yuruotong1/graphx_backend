...
public class Constant {
    public static final String LINE_LINE_ARROW = "LINE_LINE_ARROW";
    public static final String LINE_STRING_LINE_ARROW = "LINE_STRING_LINE_ARROW";
    public static final String LINE_LINE = "LINE_LINE";
    public static final String LINE_STRING_LINE = "LINE_STRING_LINE";
    public static final String TMP_FILES = "tmpfiles";
    public static final String GRAPHVIZ_NODE_EDGE = "graphvizNodeEdge";
